...
describe("BottomNav", () => {
  it("renders all 5 nav items", () => {
    ...
    expect(screen.getByTestId("nav-pronostics")).toBeInTheDocument();
  ...
  it("marks current path as active with aria-current", () => {
    ...
    expect(screen.getByTestId("nav-pronostics")).toHaveAttribute("aria-current", "page");
  ...
  it("navigates on click", async () => {
    ...
    await user.click(screen.getByTestId("nav-pronostics"));
