...
export const DEFAULT_TASKS: RoadmapTask[] = [
  ...
  },
  {
    ...
    description: "Typer toutes les réponses API avec Zod (5 endpoints critiques validés)",
    status: "done",
    priority: "high",
    category: "refactor",
    phase: "refactor",
  ...
  },
  {
    ...
    description:
      "SVG bloqué (vecteur XSS), validation magic-bytes, Cache-Control + X-Content-Type-Options sur médias.",
    status: "done",
    priority: "high",
    category: "security",
    phase: "release-reliability",
  ...
  {
    id: "v050-drivers",
    title: "Admin Pilotes & Écuries",
    description: "CRUD complet, photos F1 CDN HD, logos 640px, drag-drop upload, seed F1 2026.",
    status: "done",
    priority: "critical",
    category: "feature",
    phase: "v050-features",
  ...
  {
    id: "v050-avatars",
    title: "Avatars pilotes Pronokif",
    description: "Headshots F1 officiels dans le sélecteur d'avatar avec cadre couleur équipe.",
    status: "done",
    priority: "high",
    category: "feature",
    phase: "v050-features",
  ...
  },
  {
    ...
    description:
      "Header Content-Security-Policy-Report-Only + endpoint /api/csp-report. Enforcement après 2 semaines sans violation.",
    status: "done",
    priority: "critical",
    category: "security",
    phase: "v050-security",
  ...
  },
  {
    ...
    description:
      "5 endpoints critiques validés au boundary API (drivers, races, leagues, session, predictions).",
    status: "done",
    priority: "high",
    category: "refactor",
    phase: "v050-security",
  ...
  {
    id: "v050-bundle-split",
    title: "Bundle admin découpé par onglet",
    description: "13 tabs lazy() + Suspense. AdminLayout chunk réduit de 60%.",
    status: "done",
    priority: "high",
    category: "perf",
    phase: "v050-perf",
  ...
  },
  {
    ...
    description: "Dashboard, Courses et Fiche Grand Prix. Indicateur CSS + hook usePullToRefresh.",
    status: "done",
    priority: "medium",
    category: "ux",
    phase: "v050-perf",
  ...
  {
    id: "v050-healthcheck",
    title: "Monitoring externe cron",
    description:
      "healthcheck.yml cron 30min : frontend 200 + backend healthy + 3 endpoints critiques.",
    status: "done",
    priority: "high",
    category: "devops",
    phase: "v050-devops",
  ...
  {
    id: "v050-canary",
    title: "Canary CD 3 phases",
    description: "Attend bundle hash + health + 5 endpoints critiques dans cd.yml.",
    status: "done",
    priority: "high",
    category: "devops",
    phase: "v050-devops",
  ...
  },
  {
    ...
    description:
      "Basculer Content-Security-Policy-Report-Only → Content-Security-Policy après 0 violations prod 2 semaines.",
    status: "todo",
    priority: "high",
    category: "security",
    phase: "v050-next",
  ...
  {
    id: "v050-deploy-secret",
    title: "Auto-deploy STORMDEPLOY_WEBHOOK_SECRET",
    description:
      "Poser le secret GitHub pour que le CD merge→deploy automatiquement sans Dokploy manuel.",
    status: "todo",
    priority: "critical",
    category: "devops",
    phase: "v050-next",
