    ...
    <div className="min-h-screen bg-app-main pb-24">
      ...
      <div className="max-w-2xl mx-auto p-4">
        {activeTab === "leaderboard" ? (
          <LeagueLeaderboard leaderboard={leaderboard} members={members} userId={user.id} getAvatar={getAvatar} />
        ) : (
          <LeagueMembers members={members} leaderboard={leaderboard} userId={user.id} ownerId={league.owner_id} getAvatar={getAvatar} />
        )}
