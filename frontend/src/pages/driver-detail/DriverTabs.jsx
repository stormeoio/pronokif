...
import { InfoRow, StatCard, formatDate, factIcons, getTeamColors } from "./driverHelpers";

export function ProfileTab({ driver, colors }) {
...
export function PalmaresTab({ driver, colors }) {
...
export function FactsTab({ driver, colors }) {
