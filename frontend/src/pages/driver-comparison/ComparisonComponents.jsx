...
export function ComparisonBar({ label, icon: Icon, value1, value2, color1, color2 }) {
...
export function EfficiencyCard({ label, value1, value2, driver1, driver2, suffix }) {
  const winner = value1 > value2 ? 1 : value2 > value1 ? 2 : 0;
...
export function getVerdict(comparison, d1, d2) {
