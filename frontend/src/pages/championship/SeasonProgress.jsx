...
export default function SeasonProgress({ raceSchedule }) {
        ...
        <div className="card-arcade p-4">
          ...
          {loadingResults ? (
            ...
            <>
              ...
              {resultsTab === "qualifying" && <QualifyingResultsList results={raceResults.qualifying} />}
              {resultsTab === "sprint" && raceResults.hasSprint && <SprintResultsList results={raceResults.sprint} />}
