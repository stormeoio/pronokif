...
export function RaceResultsList({ results }) {
  return (
...
export function QualifyingResultsList({ results }) {
  return (
    <div className="space-y-2">
...
export function SprintResultsList({ results }) {
  return (
    <div className="space-y-2">
...
export function PracticeResultsList({ practice }) {
  return (
...
export function ExtrasPanel({ raceResults }) {
  return (
    <div className="space-y-4">
      {/* Fastest Lap */}
