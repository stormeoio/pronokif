...
export default function ResultsTab({ races, setRaces, drivers }) {
  const {
        ...
        <>
          ...
          {selectionMode === "bonus" && (
            <BonusPanel
              ...
              fastestLap={fastestLap} firstCornerLeader={firstCornerLeader}
              drivers={drivers} setSelectionMode={setSelectionMode}
            />
          )}
