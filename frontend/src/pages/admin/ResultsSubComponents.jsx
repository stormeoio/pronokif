...
export function BonusPanel({ safetyCar, setSafetyCar, dnfDrivers, fastestLap, firstCornerLeader, drivers, setSelectionMode }) {
  return (
...
export function DnfPanel({ dnfDrivers, setDnfDrivers, drivers, setSelectionMode }) {
  return (
    <div className="mb-4">
...
export function DriverGrid({ drivers, isDriverSelected, getDriverPosition, handleDriverSelect }) {
  return (
    <div className="grid grid-cols-2 gap-3">
      {drivers.map((driver) => {
