...
export function DeleteConfirmModal({ memberDetails, deletingMember, onCancel, onConfirm }) {
  return (
...
export function MemberInfoContent({ memberDetails }) {
  return (
    <>
...
export function MemberActivityContent({ loadingActivity, memberActivity }) {
  return (
