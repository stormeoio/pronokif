...
def test_auth_token(api_client):
    ...
    response = api_client.post(f"{BASE_URL}/api/auth/login", json={"email": "test@pronokif.com", "password": "test123"})
...
class TestLeagueChat:
    ...
    def test_send_message_to_league(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/leagues/{test_league_id}/messages", json={"content": test_message}
        )
        ...
        assert data["content"] == test_message, "Message content mismatch"
    ...
    def test_send_empty_message_rejected(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.post(f"{BASE_URL}/api/leagues/{test_league_id}/messages", json={"content": ""})
    ...
    def test_send_whitespace_message_rejected(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/leagues/{test_league_id}/messages", json={"content": "   "}
        )
    ...
    def test_send_long_message_rejected(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/leagues/{test_league_id}/messages", json={"content": long_message}
        )
    ...
    def test_get_league_messages(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/leagues/{test_league_id}/messages")
    ...
    def test_get_messages_with_limit(self, authenticated_client, test_league_id):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/leagues/{test_league_id}/messages?limit=5")
    ...
    def test_send_message_non_member_rejected(self, api_client):
        ...
        register_res = api_client.post(
            f"{BASE_URL}/api/auth/register", json={"email": unique_email, "password": "test12345"}
        )
...
class TestLeagueMembers:
    ...
    def test_get_league_members(self, authenticated_client, test_league_id, test_user_info):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/leagues/{test_league_id}/members")
    ...
    def test_get_members_non_member_rejected(self, api_client):
        ...
        response = api_client.get(
            f"{BASE_URL}/api/leagues/{uuid.uuid4()}/members", headers={"Authorization": f"Bearer {new_token}"}
        )
...
class TestPublicProfile:
    ...
    def test_get_own_profile(self, authenticated_client, test_user_info):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/users/{user_id}/profile")
    ...
    def test_profile_contains_leagues_in_common(self, authenticated_client, test_user_info):
        ...
        if leagues:
            ...
            print(
                f"✅ League info: {league['name']}, Position: #{league['position']}, Points: {league['total_points']}"
            )
        else:
    ...
    def test_get_nonexistent_user_profile(self, authenticated_client):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/users/{fake_id}/profile")
...
class TestProfileFromChat:
    ...
    def test_member_to_profile_flow(self, authenticated_client, test_league_id):
        ...
        members_res = authenticated_client.get(f"{BASE_URL}/api/leagues/{test_league_id}/members")
        ...
        member = members[0]
        profile_res = authenticated_client.get(f"{BASE_URL}/api/users/{member['id']}/profile")
        ...
        print("✅ Integration: Members → Profile flow works")
