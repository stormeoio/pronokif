...
class TestAvatarSystem:
    ...
    def test_get_all_avatars(self, api_client):
        ...
        print(
            f"✅ Avatar system: {len(data['default'])} default, {len(data['teams'])} teams, {len(data['drivers'])} drivers"
        )
    ...
    def test_avatar_invalid_id(self, authenticated_client):
        ...
        response = authenticated_client.post(f"{BASE_URL}/api/user/avatar", json={"avatar_id": "invalid_avatar_xyz"})
    ...
    def test_avatar_upload_placeholder(self, authenticated_client):
        ...
        response = requests.post(f"{BASE_URL}/api/user/avatar/upload", files=files, headers=headers)
    ...
    def test_reset_to_original_avatar(self, authenticated_client):
        ...
        response = authenticated_client.post(f"{BASE_URL}/api/user/avatar", json={"avatar_id": "driver_1"})
        assert response.status_code == 200
...
class TestMiniGamesReaction:
    ...
    def test_submit_reaction_training(self, authenticated_client, test_user_info):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/minigames/reaction",
            json={"race_id": race["id"], "league_id": league_id, "reaction_time_ms": 250, "is_training": True},
        )
    ...
    def test_submit_reaction_competition(self, authenticated_client, test_user_info):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/minigames/reaction",
            json={"race_id": race["id"], "league_id": league_id, "reaction_time_ms": 220, "is_training": False},
        )

        # May succeed or fail if 3 attempts used
        if response.status_code == 200:
            print("✅ Reaction competition result submitted")
        elif response.status_code == 400:
            error = response.json()
            if "3 attempts" in error.get("detail", ""):
                print("✅ Competition mode correctly limits attempts")
            else:
...
class TestMiniGamesBatak:
    ...
    def test_submit_batak_training(self, authenticated_client):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/minigames/batak",
            json={"race_id": race["id"], "league_id": league_id, "score": 28, "time_seconds": 30, "is_training": True},
        )
    ...
    def test_submit_batak_competition(self, authenticated_client):
        ...
        response = authenticated_client.post(
            f"{BASE_URL}/api/minigames/batak",
            json={"race_id": race["id"], "league_id": league_id, "score": 32, "time_seconds": 30, "is_training": False},
        )

        if response.status_code == 200:
            print("✅ Batak competition result submitted")
        elif response.status_code == 400:
            error = response.json()
            if "3 attempts" in error.get("detail", ""):
                print("✅ Competition mode correctly limits attempts")
...
class TestMiniGamesLeaderboard:
    ...
    def test_get_reaction_leaderboard(self, authenticated_client):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/minigames/leaderboard/reaction/{league_id}/{race['id']}")
    ...
    def test_get_batak_leaderboard(self, authenticated_client):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/minigames/leaderboard/batak/{league_id}/{race['id']}")
    ...
    def test_get_minigame_attempts(self, authenticated_client):
        ...
        response = authenticated_client.get(f"{BASE_URL}/api/minigames/attempts/reaction/{league_id}/{race['id']}")
