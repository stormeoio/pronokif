"""
Interactive circuit map seed data.

Canonical/internal fields are language-neutral (`key`, `id`, `kind`, paths).
User-visible labels and notes are locale-keyed under `label` and `note` so the
same payload can be exposed to the public app, admin editing, and the RAG layer.
"""
# ruff: noqa: E501
...
def _text(fr: str, en: str) -> dict[str, str]:
    return {"fr": fr, "en": en}


def _first_corner(hotspot_id: str, fr: str, en: str) -> dict[str, Any]:
    return {
...
CIRCUIT_MAPS: list[dict[str, Any]] = [
    {
        "key": "albert-park",
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M95 198 C78 170 83 126 112 94 C143 60 198 53 245 70 C292 87 333 118 337 158 C341 200 302 225 254 218 C218 213 204 190 173 205 C142 221 111 224 95 198 Z",
        "racingLinePath": "M105 191 C91 168 96 130 120 102 C150 68 197 64 240 79 C281 94 320 121 323 156 C326 189 294 208 254 203 C215 198 201 178 170 194 C143 208 117 211 105 191 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
                "x": 102,
                "y": 187,
                "label": _text("Ligne de départ", "Start line"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 250,
                "y": 76,
                "label": _text("Portion rapide", "Fast section"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 260,
                "y": 214,
                "label": _text("DRS principal", "Main DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M75 171 C96 120 130 91 178 90 C230 89 270 124 249 159 C229 190 169 175 173 132 C177 86 224 55 285 72 C347 89 363 139 326 176 C292 211 233 210 205 186 C178 164 144 168 113 202 C97 219 72 203 75 171 Z",
        "racingLinePath": "M90 169 C110 127 137 105 177 104 C217 103 247 126 233 152 C220 176 181 163 186 132 C191 96 230 73 280 86 C331 100 342 137 313 165 C287 191 236 190 214 172 C185 148 143 166 120 194 C105 212 88 197 90 169 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
        ...
        "zones": [
            {
                ...
                "label": _text("DRS ligne droite", "Pit straight DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M78 190 C96 160 119 133 151 124 C177 116 191 91 202 67 C216 38 259 39 280 66 C295 85 282 108 254 116 C232 122 229 142 252 156 C283 175 324 154 340 181 C359 214 313 237 268 222 C233 210 211 230 178 222 C145 214 103 232 80 208 C73 201 72 196 78 190 Z",
        "racingLinePath": "M91 187 C107 161 127 140 155 132 C188 122 193 84 212 65 C229 48 259 52 271 70 C281 85 269 98 249 103 C213 112 216 147 247 166 C282 187 320 169 327 188 C336 212 302 223 270 211 C231 197 213 218 181 211 C147 203 113 218 91 202 C84 197 86 193 91 187 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 79,
                "y": 191,
                "label": _text("Sainte-Dévote", "Sainte Devote"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 255,
                "y": 116,
                "label": _text("Épingle Fairmont", "Fairmont Hairpin"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 221,
                "y": 217,
                "label": _text("Piscine", "Swimming Pool"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("Portier - Tunnel", "Portier to Tunnel"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M83 196 C94 129 129 77 196 74 C268 71 328 104 337 154 C347 211 294 238 244 213 C211 196 201 166 166 181 C132 195 114 231 86 215 C79 211 80 203 83 196 Z",
        "racingLinePath": "M98 192 C109 137 139 93 198 89 C255 86 309 111 321 153 C335 200 289 220 250 201 C213 183 205 152 163 168 C135 179 119 211 99 202 C95 200 95 196 98 192 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 244,
                "y": 213,
                "label": _text("Dernier secteur", "Final sector"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur d'appui", "Downforce sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M74 184 C95 135 132 109 183 109 C230 109 260 84 304 74 C348 64 370 94 347 127 C326 158 278 149 259 181 C238 216 282 237 318 215 C349 196 362 223 331 241 C286 266 215 233 200 188 C189 154 146 149 123 182 C102 212 61 214 74 184 Z",
        "racingLinePath": "M90 180 C110 140 139 124 183 123 C231 122 260 99 300 89 C333 81 349 100 334 121 C315 146 273 138 250 174 C227 210 281 224 312 203 C334 188 341 213 319 226 C280 249 226 222 214 183 C202 142 148 136 111 180 C95 199 83 196 90 180 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 75,
                "y": 184,
                "label": _text("Chicane Senna", "Senna chicane"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 331,
                "y": 241,
                "label": _text("Mur des champions", "Wall of Champions"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 304,
                "y": 74,
                "label": _text("Section île Notre-Dame", "Notre-Dame island flow"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS ligne opposée", "Back straight DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M88 202 C84 153 102 96 154 76 C206 56 272 67 322 103 C365 134 354 183 314 197 C275 211 252 179 218 196 C176 216 118 240 88 202 Z",
        "racingLinePath": "M103 197 C101 157 116 111 160 91 C205 72 263 81 310 113 C342 135 337 169 307 181 C273 195 249 163 211 183 C171 202 124 221 103 197 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 322,
                "y": 103,
                "label": _text("Schlossgold", "Schlossgold"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS montée Remus", "Remus uphill DRS"),
                "note": _text(
            ...
            },
            {
                ...
                "label": _text("DRS arrière", "Back DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M90 190 C72 145 94 98 139 82 C181 67 215 86 239 118 C266 154 322 126 344 161 C367 198 323 236 273 219 C236 207 218 177 185 194 C150 212 109 226 90 190 Z",
        "racingLinePath": "M105 185 C91 149 110 111 145 96 C177 82 204 99 226 126 C258 166 318 139 330 165 C345 195 313 216 277 204 C239 191 221 162 181 181 C147 197 119 207 105 185 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 273,
                "y": 219,
                "label": _text("Dernier virage", "Final corner"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur sinueux", "Twisty sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M73 161 C83 105 124 75 179 82 C224 88 233 118 273 102 C315 86 357 111 351 153 C345 197 295 206 260 184 C232 166 209 183 195 215 C180 250 118 235 105 200 C96 176 68 190 73 161 Z",
        "racingLinePath": "M89 160 C96 116 129 92 177 97 C226 102 235 133 277 117 C309 105 338 122 337 152 C336 181 297 190 267 169 C226 141 204 176 190 207 C178 234 133 222 120 193 C109 168 86 180 89 160 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 272,
                "y": 104,
                "label": _text("Maggotts-Becketts", "Maggotts-Becketts"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS Hangar Straight", "Hangar Straight DRS"),
                "note": _text("Fenêtre d'attaque majeure avant Stowe.", "Major attack window before Stowe."),
            }
        ],
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M74 192 C92 141 132 141 155 93 C177 47 230 38 274 67 C314 93 319 138 286 162 C255 184 241 223 198 231 C157 238 119 224 99 214 C83 206 68 210 74 192 Z",
        "racingLinePath": "M90 188 C107 148 141 143 164 96 C184 57 229 53 265 76 C299 98 301 133 276 151 C243 175 232 209 196 217 C161 225 127 213 107 202 C93 195 85 202 90 188 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 73,
                "y": 192,
                "label": _text("La Source", "La Source"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 156,
                "y": 94,
                "label": _text("Eau Rouge / Raidillon", "Eau Rouge / Raidillon"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS Kemmel", "Kemmel DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M88 186 C72 151 83 104 122 78 C159 53 211 62 234 91 C250 112 232 137 203 130 C178 124 173 96 197 82 C229 63 287 65 323 96 C360 128 362 178 329 207 C294 238 228 236 187 212 C154 193 119 218 88 186 Z",
        "racingLinePath": "M103 181 C88 152 98 113 130 91 C162 69 202 75 221 97 C231 111 218 122 203 118 C190 115 187 100 204 91 C231 76 281 80 312 106 C341 131 342 170 316 193 C286 218 232 216 197 197 C156 174 129 204 103 181 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 84,
                "y": 150,
                "label": _text("Tarzanbocht", "Tarzanbocht"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 203,
                "y": 129,
                "label": _text("Hugenholtz", "Hugenholtz"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 319,
                "y": 98,
                "label": _text("Scheivlak", "Scheivlak"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 327,
                "y": 207,
                "label": _text("Arie Luyendyk", "Arie Luyendyk"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur des dunes", "Dune sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M78 198 C91 116 131 55 206 55 C293 55 338 111 318 157 C298 202 235 185 213 224 C193 260 106 247 82 217 C77 211 76 204 78 198 Z",
        "racingLinePath": "M93 195 C106 125 139 71 206 71 C279 71 317 114 303 151 C289 187 238 172 222 211 C207 244 132 233 99 211 C92 206 91 201 93 195 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 79,
                "y": 198,
                "label": _text("Variante del Rettifilo", "Rettifilo chicane"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 213,
                "y": 223,
                "label": _text("Parabolica", "Parabolica"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M82 188 C95 129 139 87 199 79 C252 72 303 94 335 132 C367 170 347 218 300 229 C263 238 235 215 207 190 C178 164 142 201 108 213 C88 220 77 207 82 188 Z",
        "racingLinePath": "M98 184 C112 137 148 101 200 94 C245 88 289 106 318 139 C344 169 329 202 295 211 C259 221 236 198 214 178 C184 151 148 187 115 199 C102 204 94 197 98 184 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 199,
                "y": 79,
                "label": _text("Section IFEMA", "IFEMA section"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 335,
                "y": 132,
                "label": _text("Valdebebas", "Valdebebas"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M76 196 C96 122 151 86 220 91 C271 95 308 75 337 105 C365 134 341 174 303 167 C270 161 258 130 229 145 C193 164 230 218 184 235 C138 252 67 231 76 196 Z",
        "racingLinePath": "M92 191 C111 133 158 104 219 105 C272 106 303 90 325 112 C344 131 325 153 301 151 C261 149 253 116 220 133 C178 154 220 204 181 218 C142 233 87 217 92 191 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 229,
                "y": 145,
                "label": _text("Section château", "Castle section"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 337,
                "y": 105,
                "label": _text("Front de mer", "Seaside run"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur château", "Castle sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M82 188 C101 132 145 100 202 100 C248 100 285 78 326 96 C364 113 363 156 332 179 C300 203 252 183 238 217 C224 250 162 246 125 221 C100 204 75 210 82 188 Z",
        "racingLinePath": "M98 184 C116 140 153 116 201 115 C251 114 284 94 316 108 C344 120 345 149 321 166 C287 191 247 169 225 207 C209 235 167 230 136 209 C113 194 93 200 98 184 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 202,
                "y": 100,
                "label": _text("Anderson Bridge", "Anderson Bridge"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 238,
                "y": 217,
                "label": _text("Derniers virages", "Final corners"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur urbain", "Street sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M83 195 C86 143 121 92 176 78 C228 65 283 81 322 117 C358 150 346 195 306 211 C268 227 232 199 203 217 C165 240 106 236 83 195 Z",
        "racingLinePath": "M99 190 C104 150 131 109 181 94 C223 82 269 95 304 126 C332 150 326 181 298 193 C262 209 232 182 196 203 C161 224 113 219 99 190 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 322,
                "y": 117,
                "label": _text("Ligne droite arrière", "Back straight"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS ligne arrière", "Back straight DRS"),
                "note": _text(
            ...
            },
            {
                ...
                "label": _text("Premier secteur", "First sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M76 196 C92 128 145 82 212 82 C276 82 338 113 346 164 C354 216 300 238 252 211 C217 191 205 157 171 176 C136 196 95 232 76 196 Z",
        "racingLinePath": "M92 191 C108 137 153 97 212 98 C268 98 321 122 330 163 C338 200 295 218 259 197 C219 174 208 143 166 162 C136 176 103 213 92 191 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 252,
                "y": 211,
                "label": _text("Peraltada", "Peraltada"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur stade", "Stadium sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M82 194 C93 135 137 91 196 82 C252 73 317 100 338 150 C358 198 319 237 267 224 C226 214 214 176 177 190 C139 205 103 232 82 194 Z",
        "racingLinePath": "M98 188 C111 142 146 105 198 97 C246 91 300 113 320 152 C337 185 309 211 271 207 C230 202 216 160 172 176 C140 187 110 211 98 188 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 82,
                "y": 194,
                "label": _text("S de Senna", "Senna S"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 196,
                "y": 82,
                "label": _text("Descida do Lago", "Descida do Lago"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 338,
                "y": 150,
                "label": _text("Pinheirinho", "Pinheirinho"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS montée finale", "Final climb DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M70 196 C92 120 154 86 236 88 C309 90 356 122 350 166 C344 210 286 222 238 198 C203 181 182 212 137 220 C98 226 61 218 70 196 Z",
        "racingLinePath": "M87 190 C111 132 166 104 234 103 C298 102 333 127 333 160 C333 191 286 203 245 183 C203 162 181 196 136 204 C105 209 82 205 87 190 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 350,
                "y": 166,
                "label": _text("The Strip", "The Strip"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS Strip", "Strip DRS"),
                "note": _text(
            ...
            },
            {
                ...
                "label": _text("Secteur final", "Final sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M88 190 C92 128 137 82 204 76 C277 70 337 111 346 169 C355 225 297 241 246 213 C207 192 196 158 161 178 C126 198 86 223 88 190 Z",
        "racingLinePath": "M104 185 C109 137 148 99 205 92 C265 85 318 119 330 168 C342 209 293 222 253 199 C212 175 199 145 157 164 C129 177 104 205 104 185 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 204,
                "y": 76,
                "label": _text("Secteur rapide", "Flowing sector"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 346,
                "y": 169,
                "label": _text("Section arrière", "Back section"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur haute vitesse", "High-speed sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M84 194 C96 126 148 84 214 82 C281 80 341 116 350 168 C359 220 310 242 260 219 C222 202 205 169 169 185 C132 201 95 229 84 194 Z",
        "racingLinePath": "M100 188 C113 136 158 100 214 98 C271 96 322 125 333 167 C342 204 305 221 266 204 C225 186 208 155 166 171 C136 183 106 209 100 188 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 260,
                "y": 219,
                "label": _text("Secteur marina", "Marina sector"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M92 178 C74 142 87 98 129 82 C173 65 238 72 258 111 C278 151 228 174 190 150 C151 126 157 82 210 69 C278 52 345 82 358 138 C372 199 315 229 246 218 C190 209 121 235 92 178 Z",
        "racingLinePath": "M106 174 C91 143 104 109 137 96 C173 82 226 86 244 116 C261 145 226 159 197 141 C167 122 174 91 216 82 C270 70 329 95 342 139 C356 188 308 211 249 201 C195 192 125 217 106 174 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 129,
                "y": 82,
                "label": _text("Escargot T1-T2", "T1-T2 snail"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 238,
                "y": 124,
                "label": _text("Milieu technique", "Technical middle"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 358,
                "y": 138,
                "label": _text("Épingle T14", "T14 hairpin"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur 1", "Sector 1"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M82 193 C99 131 153 86 219 81 C281 76 331 112 340 165 C350 224 288 232 247 204 C214 181 227 145 263 153 C297 160 305 199 270 216 C220 241 154 229 125 204 C101 184 73 223 82 193 Z",
        "racingLinePath": "M98 188 C115 138 160 101 219 96 C271 92 313 120 324 164 C335 207 291 215 255 191 C226 171 237 150 263 163 C285 174 285 197 263 206 C220 224 163 214 137 193 C115 176 93 205 98 188 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 263,
                "y": 153,
                "label": _text("Secteur traction", "Traction sector"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("DRS vers T4", "DRS to T4"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M77 199 C96 151 119 111 169 86 C218 62 296 59 338 99 C381 140 352 201 293 218 C228 237 179 202 196 160 C210 125 260 118 277 146 C294 177 250 202 204 191 C157 180 113 219 77 199 Z",
        "racingLinePath": "M92 194 C111 154 133 121 176 100 C221 78 286 76 323 108 C357 138 335 184 289 199 C236 216 198 190 211 163 C222 140 253 136 263 152 C274 171 246 185 209 176 C163 166 125 204 92 194 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 169,
                "y": 86,
                "label": _text("Esses rapides", "Fast esses"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 293,
                "y": 218,
                "label": _text("Épingle finale", "Final hairpin"),
                "note": _text(
        ...
        "zones": [
            {
                ...
                "label": _text("DRS corniche", "Corniche DRS"),
                "note": _text(
    ...
    },
    {
        ...
        "viewBox": "0 0 420 280",
        "trackPath": "M90 190 C104 124 153 81 214 77 C281 73 334 105 349 160 C365 220 314 240 253 221 C202 205 171 169 194 137 C217 105 280 122 275 163 C270 207 196 224 139 205 C111 196 83 224 90 190 Z",
        "racingLinePath": "M105 185 C119 134 162 96 215 92 C270 89 316 116 331 160 C345 205 306 222 258 207 C216 194 192 166 210 142 C226 121 262 132 258 160 C254 190 197 207 146 191 C121 183 100 207 105 185 Z",
        "features": [
            {
                "id": "start",
                "kind": "start",
            ...
            },
            {
                ...
                "x": 214,
                "y": 77,
                "label": _text("Hard Rock Stadium", "Hard Rock Stadium"),
                "note": _text(
            ...
            },
            {
                ...
                "x": 194,
                "y": 137,
                "label": _text("Section lente", "Tight section"),
                "note": _text(
        ...
        "zones": [
            ...
            },
            {
                ...
                "label": _text("Secteur stadium", "Stadium sector"),
                "note": _text(
...
_FIRST_CORNERS_BY_KEY = {
    ...
    "monaco": _first_corner("sainte-devote", "Sainte-Dévote", "Sainte-Dévote"),
    "barcelona": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "montreal": _first_corner("senna-s", "Chicane Senna", "Senna chicane"),
    "red-bull-ring": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "hungaroring": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "silverstone": _first_corner("abbey", "Abbey", "Abbey"),
    "spa-francorchamps": _first_corner("la-source", "La Source", "La Source"),
    "zandvoort": _first_corner("tarzan", "Tarzanbocht", "Tarzanbocht"),
    "monza": _first_corner("rettifilo", "Variante del Rettifilo", "Variante del Rettifilo"),
    "madrid": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "baku": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "marina-bay": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "cota": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "hermanos-rodriguez": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "interlagos": _first_corner("senna-s", "S de Senna", "Senna S"),
    "las-vegas": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "lusail": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "yas-marina": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "shanghai": _first_corner("snail", "Escargot T1-T2", "T1-T2 snail"),
    "sakhir": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "jeddah": _first_corner("turn-1", "Virage 1", "Turn 1"),
    "miami": _first_corner("turn-1", "Virage 1", "Turn 1"),
}

for circuit_map in CIRCUIT_MAPS:
    first_corner = _FIRST_CORNERS_BY_KEY.get(circuit_map["key"])
    if first_corner:
        circuit_map["firstCorner"] = deepcopy(first_corner)
...
_MAP_LOOKUP: dict[str, dict[str, Any]] = {}
for circuit_map in CIRCUIT_MAPS:
    for alias in {circuit_map["circuitName"], *circuit_map["aliases"]}:
        _MAP_LOOKUP[_normalize_key(alias)] = circuit_map


def get_circuit_map(circuit_name: str | None) -> dict[str, Any] | None:
    """Return an editable map payload for a circuit, if one is seeded."""
    if not circuit_name:
        return None
    circuit_map = _MAP_LOOKUP.get(_normalize_key(circuit_name))
    return deepcopy(circuit_map) if circuit_map else None


def get_circuit_image_url(circuit_name: str | None) -> str | None:
    """Return a static image fallback for all known 2026 circuits."""
    if not circuit_name:
        return None
    normalized = _normalize_key(circuit_name)
    for name, url in CIRCUIT_IMAGES.items():
        if _normalize_key(name) == normalized:
            return url
    circuit_map = get_circuit_map(circuit_name)
    return str(circuit_map["fallbackImageUrl"]) if circuit_map else None


def circuit_map_brief(circuit_map: dict[str, Any] | None, locale: str = "fr") -> str | None:
    """Build a concise human/RAG summary of the interactive map metadata."""
    if not circuit_map:
        return None

    first_corner = circuit_map.get("firstCorner") if isinstance(circuit_map.get("firstCorner"), dict) else {}
    first_corner_label = (first_corner.get("label") or {}).get(locale) or (first_corner.get("label") or {}).get("fr")
    first_corner_note = (first_corner.get("note") or {}).get(locale) or (first_corner.get("note") or {}).get("fr")
    first_corner_part = ""
    if first_corner_label:
        hotspot_id = first_corner.get("hotspotId")
        suffix = f": {str(first_corner_note).rstrip()}" if first_corner_note else ""
        end = "" if suffix.endswith((".", "!", "?")) else "."
        first_corner_part = f"Premier virage identifié ({hotspot_id}): {first_corner_label}{suffix}{end} "

    labels: list[str] = []
    for item in [*circuit_map.get("features", []), *circuit_map.get("zones", [])]:
        label = (item.get("label") or {}).get(locale) or (item.get("label") or {}).get("fr")
        note = (item.get("note") or {}).get(locale) or (item.get("note") or {}).get("fr")
        if label and note:
    ...
    if not labels:
        return first_corner_part.strip() or None
    return f"{first_corner_part}Points de carte interactive: " + " ".join(labels)
